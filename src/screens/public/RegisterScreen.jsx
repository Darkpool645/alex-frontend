...
const RegisterScreen = () => {
    ...
    const validationSchema = {
        ...
        emailContact: { required: true, type: "email" },
        phoneContact: { required: true, type: "number", minLength: 10, maxLength: 30 },
    ...
    return (
        <div className="min-h-[calc(100vh-3.6rem)] flex flex-col items-center justify-start pt-24 w-full">
            <h2 className="text-3xl font-bold text-center text-blue-900">Registrar mi escuela</h2>
                ...
                <form className="flex flex-col space-y-3" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-4">
                        <InputField
                            ...
                            errorMessage={errors.emailContact}
                        ...
                        <InputField
                            ...
                            errorMessage={errors.phoneContact}
                    ...
                    <FileDropInput
                        ...
                        onChange={(file) => handleChange("schoolLogo")({ target: { value: file } })}
                        onBlur={() => validateField("schoolLogo", formData.schoolLogo)}
                        accept={{ "image/png": [], "image/jpg": [] }}
                        error={!!errors.schoolLogo}
                        errorMessage={errors.schoolLogo}
                    />
                    <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-4">
                        <InputField
                            label="Nombre"
                    ...
                    <button type="submit" className="bg-blue-900 text-white rounded-lg py-2 px-3 w-full font-semibold mt-10 mb-10">
